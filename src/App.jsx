...
const App = () => {
  ...
  const handleWeightChange = (e) => {
    const rawValue = e.target.value.replace(/\D/g, '');
    const numericValue = rawValue ? parseFloat(rawValue) / 1000 : '';
              ...
              <form onSubmit={handleSaveItem} className="space-y-4 pb-6">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-[2]">
                    ...
                    {formData.unit === 'kg' ? (
                      <input type="tel" inputMode="numeric" placeholder="Ex: 1,500" className="w-full p-4 bg-gray-50 border-2 border-transparent focus:border-emerald-500 rounded-xl outline-none text-base font-semibold text-center" value={formData.quantity ? formData.quantity.toLocaleString('pt-BR', { minimumFractionDigits: 3 }) : ''} onChange={handleWeightChange} />
                    ) : (
